...
import DitWorkflow from "../components/DitWorkflow";
...
const expertise = [
  ...
  { title: "数字影像工程师", english: "Digital Imaging Technician", desc: "关注素材安全、画面监看与现场色彩一致性，帮助拍摄和后期更顺畅对接。", items: ["素材备份与校验", "监看链路管理", "基础 LUT 与画面统一"], workflow: true },
];
            ...
            {expertise.map((item) => (
              <div className="expertise-card-motion" key={item.title}>
                ...
                >
                  ...
                  {item.workflow ? <DitWorkflow /> : null}
                </GlareHover>
              </div>
            ))}
          </div>
