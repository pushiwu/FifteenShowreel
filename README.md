...
蒲师武个人影像作品集，当前由 `main` 分支持续维护。网站以 React、Vite、GSAP 与 Canvas2D 构建，包含电影化 opening、滚动叙事、动态人物 ASCII 轮廓及项目视频播放页。历史上线基线保留为 `v1.0.0`，版本号在生产发布成功后自动递增。

核心作品以摄影指导项目《木木的路》开场，提供双语作品摘要与可展开的摄影阐述。作品轮播支持手动切换与暂停，手机导航可直达各章节。履历默认展示前六项奖项，其余可展开；作品与奖项数量由共享数据自动统计。
